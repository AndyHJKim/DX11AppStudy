#include "pch.h"
#include "DX11AppStudyMain.h"
#include "Common\DirectXHelper.h"

using namespace DX11AppStudy;
using namespace Windows::Foundation;
using namespace Windows::System::Threading;
using namespace Concurrency;

// 응용 프로그램이 로드되면 응용 프로그램 자산을 로드하고 초기화합니다.
DX11AppStudyMain::DX11AppStudyMain(const std::shared_ptr<DX::DeviceResources>& deviceResources) :
...
DX11AppStudyMain::~DX11AppStudyMain()
{
	// 장치 알림 등록 취소
...
void DX11AppStudyMain::CreateWindowSizeDependentResources() 
{
...
void DX11AppStudyMain::OnDeviceLost()
{
...
void DX11AppStudyMain::OnDeviceRestored()
{
